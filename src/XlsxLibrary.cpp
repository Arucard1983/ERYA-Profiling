...
wxString XlsxFile::GetXlsxApp()
{
 ...
 version->AddChild(new wxXmlNode(wxXML_TEXT_NODE, wxEmptyString, ERYAProfilingERYAProfilingMain::GetAppVersion()));
 ...
 appname->AddChild(new wxXmlNode(wxXML_TEXT_NODE, wxEmptyString, wxT("ERYA-Profiling")));
 //Export the file as a wxString
...
wxString XlsxFile::GetXlsxCore()
{
 ...
 maker->AddChild(new wxXmlNode(wxXML_TEXT_NODE, wxEmptyString, wxT("ERYA-Profiling")));
 //Export the file as a wxString
