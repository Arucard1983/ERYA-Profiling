...
class ERYAProfilingERYAProfilingMain : public ERYAProfilingMain
{
	protected:
        ...
        bool EnableLog;
        int RessonanceMode;
        unsigned int SamplePrecision, LandauPrecision, VavilovEdgeworthPrecision, VavilovMoyalPrecision, VavilovAiryPrecision, GaussPrecision, ThreadPrecision, ModePrecision;
	...
	//// end generated class members
        ...
        void GetPrecisionParameters(unsigned int& CP, unsigned int& G, unsigned int& VM, unsigned int& VE, unsigned int& VA, unsigned int& L, unsigned int& NT, unsigned int& CM, bool& EL){CP = SamplePrecision; G = GaussPrecision; VM = VavilovMoyalPrecision; VE = VavilovEdgeworthPrecision; VA = VavilovAiryPrecision; L = LandauPrecision; NT = ThreadPrecision; CM = ModePrecision; EL = EnableLog; return;};
	    void SetPrecisionParameters(unsigned int CP, unsigned int G, unsigned int VM, unsigned int VE, unsigned int VA, unsigned int L, unsigned int NT, unsigned int CM, bool EL){SamplePrecision = CP; GaussPrecision = G; VavilovMoyalPrecision = VM; VavilovEdgeworthPrecision = VE; VavilovAiryPrecision = VA; LandauPrecision = L; ThreadPrecision = NT; ModePrecision = CM; EnableLog = EL; return;};
