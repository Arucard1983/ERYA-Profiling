...
class ElementDatabase
{
   ...
   ElementDatabase(wxTextCtrl* EditElement, wxTextCtrl* EditGamma, wxTextCtrl* EditNumber, wxTextCtrl* EditAbundance, wxTextCtrl* EditAtomic, wxTextCtrl* EditIsotopic, wxGrid* DataEditor, wxString Info);
...
class ElementDatabaseArray : public ElementDatabaseList
{
  ...
  bool FindGetAllElementInfo(wxString GetElement, wxString GetGammaPeak, wxChoice* &ListElement, wxChoice* &ListGammaPeak, wxTextCtrl* &SetNumber, wxTextCtrl* &SetAbundance, wxTextCtrl* &SetMass, wxTextCtrl* &SetIsotopic);
...
class ZieglerParameters
{
  ...
  public:
   ...
   wxArrayString GetZieglerDensity(){return ZieglerDensity;};
   wxArrayString GetZieglerBloch(){return ZieglerBloch;};
   wxString GetZieglerVersion(){return ZieglerVersion;};
   void SetZieglerVersion(wxString v){ ZieglerVersion = v;};
   void AddZieglerParameterData(wxString e, wxString v1, wxString v2, wxString v3, wxString v4, wxString v5, wxString v6, wxString v7, wxString v8, wxString v9, wxString v10, wxString v11, wxString v12, wxString m, wxString d, wxString b);
   ...
   bool FixDensity(wxArrayString ListDensity);
   bool FixBloch(wxArrayString ListBloch);
   void Clear();
