...
ERYAProfilingwizardFirstRun::ERYAProfilingwizardFirstRun( wxWindow* parent )
:
...
void ERYAProfilingwizardFirstRun::OnFirstRunFinish( wxWizardEvent& event )
{
