/***************************************************************
 * Name:      ERYAProfilingdialogAddDatabase.cpp
...
ERYAProfilingdialogAddDatabase::ERYAProfilingdialogAddDatabase( wxWindow* parent)
:
...
void ERYAProfilingdialogAddDatabase::OnDatabaseSelect( wxGridRangeSelectEvent& event )
{
  dataClipboard->Clear();
...
void ERYAProfilingdialogAddDatabase::OnDatabaseCopy( wxCommandEvent& event )
{
...
void ERYAProfilingdialogAddDatabase::OnDatabasePaste( wxCommandEvent& event )
{
  if (wxTheClipboard->Open())
  {
...
void ERYAProfilingdialogAddDatabase::OnImportR33( wxCommandEvent& event )
{
wxFileDialog *OpenDialog = new wxFileDialog(this, wxT("Select an IBANDL file to open"), wxEmptyString, wxEmptyString, wxT("IBANDL file (*.r33)|*.r33|Text Excitation Table file (*.txt)|*.txt|Text Excitation Table file (*.dat)|*.dat|Excel Xlsx file (*.xlsx)|*.xlsx"), wxFD_OPEN, wxDefaultPosition);
...
else if (file.GetExt() == wxT("xlsx"))
{
 ...
 if(XlsxSigmaFile.LoadFile())
 {
   ...
   ERYAProfilingdialogXlsxDataImport* datapanel = new ERYAProfilingdialogXlsxDataImport(this);
   datapanel->ShowModal();
...
void ERYAProfilingdialogAddDatabase::OnExportR33( wxCommandEvent& event )
{
...
void ERYAProfilingdialogAddDatabase::OnEditClear( wxCommandEvent& event )
{
tableDataEditor->ClearGrid();
...
void ERYAProfilingdialogAddDatabase::OnEditSave( wxCommandEvent& event )
{
...
void ERYAProfilingdialogAddDatabase::OnEditCancel( wxCommandEvent& event )
{
 // Call the parent frame
ERYAProfilingdialogDatabaseManager *Parent = (ERYAProfilingdialogDatabaseManager *) GetParent();
