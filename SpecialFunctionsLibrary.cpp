...
double LandauFunction::L(double lambda)
{
 ...
 else if (lambda > -3.4 && lambda <= -1)
 {
  ...
  double g = 1 + 0.01*std::exp(6.7853 + 4.884*lambda + 1.44881*std::pow(lambda,2) + 0.2080242*std::pow(lambda,3) + 0.01205744*std::pow(lambda,4));
  return f*g;
 }
...
// Moyal Parameters. (An hard-coded table)
double VavilovMoyalFunction::VMTable(unsigned int z, unsigned int i, unsigned int m, unsigned int n)
{
 ...
 VMT[0][4][0] = 1; VMT[0][4][1] = 0; VMT[0][4][2] = 0.032477982; VMT[0][4][3] = 0.040797543; VMT[0][4][4] = 0.064820468; VMT[0][4][5] = -0.20374501; VMT[0][4][6] = -0.10368495; VMT[0][4][7] = -0.027542114; VMT[0][4][8] = -3.5619655; VMT[0][4][9] = -11.825253;
 ...
 VMT[0][8][0] = 2; VMT[0][8][1] = 0; VMT[0][8][2] = -0.0050920496; VMT[0][8][3] = -0.0091490215; VMT[0][8][4] = -0.023615759; VMT[0][8][5] = 0.095055662; VMT[0][8][6] = 0.0014330117; VMT[0][8][7] = 0.012631023; VMT[0][8][8] = 0.69387764; VMT[0][8][9] = 4.3133087;
 ...
 VMT[1][1][0] = 0; VMT[1][1][1] = 1; VMT[1][1][2] = 0.045091424; VMT[1][1][3] = 0.12693878; VMT[1][1][4] = 0.053921588; VMT[1][1][5] = -0.14986093; VMT[1][1][6] = -0.010775802; VMT[1][1][7] = 0.013346861; VMT[1][1][8] = -1.2218009; VMT[1][1][9] = -1.8160479;
 ...
 VMT[2][4][0] = 1; VMT[2][4][1] = 0; VMT[2][4][2] = 0.0097572934; VMT[2][4][3] = 0.14474912; VMT[2][4][4] = 0; VMT[2][4][5] = -0.0026863185; VMT[2][4][6] = 0.032738857; VMT[2][4][7] = -0.0016300060; VMT[2][4][8] = 0; VMT[2][4][9] = -0.73866379;
 ...
 VMT[2][9][0] = 2; VMT[2][9][1] = 1; VMT[2][9][2] = 0.0018831112; VMT[2][9][3] = 0.0050574313; VMT[2][9][4] = 0.0085359607; VMT[2][9][5] = -0.016209200; VMT[2][9][6] = 0; VMT[2][9][7] = -0.0014346306; VMT[2][9][8] = 0; VMT[2][9][9] = 0;
...
double VavilovMoyalFunction::VMMain(double k, double beta, double lambda)
{
 ...
 if(k>=0.02 && k<0.22)
 {
   double lambda0; //Absolute minimum value cut-off
   if(k>=0.02 && k<0.12)
   {
    lambda0 = -3.03;
   }
...
// Fix the Vavilov-Moyal function for some values
double VavilovMoyalFunction::VMFix(double k, double beta, double lambda)
{
 double fksup,fkinf,ksup,kinf,csup,cinf;
 if(k>=0.06 && k<0.12)
 {
   ksup = 0.12;
   kinf = 0.06;
 }
 else if(k>=0.2 && k<=0.23)
 {
   ksup = 0.23;
   kinf = 0.2;
 }
 ...
 {
   return this->VMMain(k,beta,lambda);
 }
 fksup = this->VMMain(ksup,beta,lambda);
 fkinf = this->VMMain(kinf,beta,lambda);
 csup = (ksup - k)/(ksup - kinf);
 cinf = (k - kinf)/(ksup - kinf);
 return (cinf*fkinf + csup*fksup)/2;
}
...
double VavilovMoyalFunction::GetValue(double AtEnergy)
{
 ...
 return this->VMFix(VMCk,VMCbeta,MoyalLambda);
}
