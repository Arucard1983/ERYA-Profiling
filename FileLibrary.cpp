...
bool ERYAProfilingSampleFile::ERYAProfilingSampleSave(ArrayElement choiceElementName, ArrayGammaPeak choiceGammaPeak, ArrayAtomicNumber textAtomicNumber, ArrayAbundance textAbundance, ArrayIsotopicMass textIsotopicMass, ArrayAtomicMass textAtomicMass, ArrayCalibrationFactor textCalibrationFactor, ElementDatabaseArray OpenDatabase)
{
  ...
  wxXmlNode* fileversion = new wxXmlNode(database, wxXML_ELEMENT_NODE, "File_Details");
   ...
   wxXmlNode* programversion = new wxXmlNode(details, wxXML_ELEMENT_NODE, "Program_Version");
     programversion->AddChild(new wxXmlNode(wxXML_TEXT_NODE, wxEmptyString, ERYAProfilingERYAProfilingMain::GetAppVersion()));
    ...
    if(GlobalNode->GetName() == wxT("Precision_Data")) //Main data entry point
    {
     ...
     while(PrecisionData)
     {
      if(PrecisionData->GetName() == wxT("Precision_Table"))
      {
        ...
        {
         wxString SampleData,GaussData,MoyalData,EdgeworthData,AiryData, LandauData, ThreadData, VavilovData, LogData;
         unsigned long SampleValue, GaussValue, MoyalValue, EdgeworthValue, AiryValue, LandauValue, ThreadValue, VavilovValue, LogValue;
         ...
         ThreadData = PrecisionValues->GetAttribute(wxT("Thread_Step"),wxT("1"));
         ...
         ThreadData.ToULong(&ThreadValue);
         ...
         ThreadStep = static_cast<unsigned int>(ThreadValue);
  ...
  wxXmlNode* data0 = new wxXmlNode(global, wxXML_ELEMENT_NODE, "Precision_Data"); //Advanced root
   wxXmlNode* block0 = new wxXmlNode(data0, wxXML_ELEMENT_NODE, "Precision_Table");
    wxXmlNode* datalabel0 = new wxXmlNode(block0, wxXML_ELEMENT_NODE, "Precision_Values");
     ...
     datalabel0->AddAttribute(wxT("Thread_Step"),wxString::Format("%ui",ThreadStep));
